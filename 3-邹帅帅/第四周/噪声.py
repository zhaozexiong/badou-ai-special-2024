...
gsnoise_img = util.random_noise(img, mode='poisson')
jy_img = util.random_noise(img, mode='s&p')

cv2.imshow('source', img)
cv2.imshow('lenna', gsnoise_img)
cv2.imshow('lena', jy_img)

# cv2.imwrite(r'E:\image\lenna_gs.png', jy_img)
